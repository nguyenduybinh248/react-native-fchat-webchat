...
class Header extends PureComponent {
    ...
    render() {
        ...
        return <View style={{ width: '100%', flexDirection: 'row', alignItems: 'center', backgroundColor: colors.brand_color, justifyContent: 'space-between', paddingHorizontal: 10, height: 60, borderBottomColor: 'silver', borderBottomWidth: StyleSheet.hairlineWidth }}>
            {this.props.type == 'conversation_detail' ? <TouchableOpacity onPress={this.goBack}>
                <Image source={require('../assets/images/chevron-left.png')} style={{ width: 20, height: 20, borderRadius: 15, }} />
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end' }}>
                {phone ? <TouchableOpacity onPress={this.call}>
                    <Image source={require('../assets/images/phone.png')} style={{ width: 30, height: 30, borderRadius: 15, }} />
                </TouchableOpacity> : null}
                <TouchableOpacity onPress={this.closeWebChat}>
                    <Image source={require('../assets/images/close.png')} style={{ width: 25, height: 25, marginLeft: 5, }} />
                </TouchableOpacity>
            </View>
        </View>
